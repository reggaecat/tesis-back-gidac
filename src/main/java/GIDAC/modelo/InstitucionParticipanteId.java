...
public class InstitucionParticipanteId implements Serializable {
    private Integer idInstitucion;
    private Integer idProyecto;

    public InstitucionParticipanteId() {
        // Constructor sin argumentos
    }

    public InstitucionParticipanteId(Integer idInstitucion, Integer idProyecto) {
    ...
    public boolean equals(Object o) {
        ...
        InstitucionParticipanteId that = (InstitucionParticipanteId) o;
