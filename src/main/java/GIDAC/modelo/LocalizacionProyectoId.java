...
public class LocalizacionProyectoId implements Serializable {
    private Integer idProyecto;
    private Integer idLocalizacion;
    
    
    
    public LocalizacionProyectoId() {
        // Constructor sin argumentos
    }

    public LocalizacionProyectoId(Integer idProyecto, Integer idLocalizacion) {
    ...
    public boolean equals(Object o) {
        ...
        LocalizacionProyectoId that = (LocalizacionProyectoId) o;
        return Objects.equals(idProyecto, that.idProyecto) &&
                Objects.equals(idLocalizacion, that.idLocalizacion);
    }

    @Override
    public int hashCode() {
        return Objects.hash(idProyecto, idLocalizacion);
    }
}
